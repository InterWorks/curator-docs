---
title: 'Adding Your First Dashboard'
description: 'Step-by-step guide to create your first analytics connection and add dashboards to Curator.'
---
...
![Dashboard dropdowns](/assets/images/setup/trial_quick_start_guide/adding-dashboard-from-server-1.png)

Connect dashboards will be listed in the Tableau → Dashboard menu:
![Dashboard list](/assets/images/setup/trial_quick_start_guide/box-notes-image-2023-08-07-133321.png)
...
![homepage hero image and menu](/assets/images/setup/trial_quick_start_guide/box-notes-image-2023-08-07-123206.png)
...
![navigation reorder view](/assets/images/setup/trial_quick_start_guide/box-notes-image-2023-08-07-124312.png)
...
![homepage hero image and menu](/assets/images/setup/trial_quick_start_guide/box-notes-image-2023-08-07-124522.png)
