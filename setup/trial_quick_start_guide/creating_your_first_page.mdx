...
description: 'Learn how to use the page builder to create and customize your first content page in Curator.'
---
...
![empty page](/assets/images/setup/trial_quick_start_guide/van-ness-page.png)
...
![page elements modal hero image highlighted](/assets/images/setup/trial_quick_start_guide/box-notes-image-2023-08-07-125531.png)
...
![Analytics Element modal](/assets/images/setup/trial_quick_start_guide/box-notes-image-2023-08-07-131816.png)

### Add a Text Field

![page elements modal text highlighted](/assets/images/setup/trial_quick_start_guide/box-notes-image-2023-08-07-145647.png)

Make updates to your text like bolding, italicizing, strike-through and many more options in the text editor.
![wysiwyg text editor](/assets/images/setup/trial_quick_start_guide/box-notes-image-2023-08-07-152645.png)

### Add Buttons

![page elements modal buttons highlighted](/assets/images/setup/trial_quick_start_guide/box-notes-image-2023-08-07-152233.png)
