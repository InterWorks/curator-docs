...
connection set up first.  Review the steps for [creating your integration](/creating_integrations/overview) in our documentation, and then come
back here to set up your authentication.
