...
description: 'Configure Curator for high availability infrastructure to ensure reliability and handle increased load'
---
...
![HA diagram](/assets/images/setup/high_availability/ha-diagram.png)
