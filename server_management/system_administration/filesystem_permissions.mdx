...
description: 'Configure proper filesystem permissions for Curator to ensure correct operation of job systems and file access controls.'
---
...
![Windows: Permission Fix](/assets/images/server_management/system_administration/permissions_fix.png)
