---
title: 'Creating a Tableau Connection'
description: 'Learn how to connect Curator to your Tableau Server or Tableau Cloud site using REST API for seamless dashboard integration.'
---
