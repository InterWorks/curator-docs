---
title: 'Adding a Pulse Metric'
description: 'Add and configure Tableau Pulse metrics for real-time dashboard performance monitoring and alerts.'
---
...
![Modal showing analytic elements and highlighting Tableau metric option](/assets/images/embedding_using_analytics/tableau_metric/adding_pulse_metric_page_builder.png)
