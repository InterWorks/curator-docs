---
title: 'Updating Data Groups'
description: 'Modify existing Data Groups to add new fields and information requirements while preserving previously collected data.'
---
