---
title: 'Web Data Connector (WDC)'
description: 'Integrate external data sources using Web Data Connector technology for dynamic data access in analytics platforms.'
---
