---
title: 'Filters'
description: 'Configure and implement filters to enable users to interactively control dashboard content and focus on specific data subsets.'
---
...
![Overview of the top section - Filter fields](/assets/images/embedding_using_analytics/filters_parameters/filter_fields.png)
