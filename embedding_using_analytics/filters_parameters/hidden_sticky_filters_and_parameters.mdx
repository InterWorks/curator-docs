---
title: 'Hidden Sticky Filters and Parameters'
description: 'Configure invisible persistent filters and parameters that remain active across user sessions and dashboard navigation.'
---
