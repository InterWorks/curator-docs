---
title: 'URL Action Overrides (Link Target)'
description: 'Configure URL actions in Tableau dashboards to control link behavior and user navigation within Curator.'
---
