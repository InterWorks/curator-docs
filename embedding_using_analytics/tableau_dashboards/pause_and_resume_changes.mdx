---
title: 'Pause and Resume Changes'
description: 'Enable users to pause dashboard refreshes while applying multiple filters and parameters for better performance.'
---
