...
If you have not added a Dashboard yet, check out our [Adding a Dashboard Guide](https://curator.interworks.com/page/kb/embedding-using-analyticstableau-dashboards/adding-a-dashboard/1044)
...
- **Dashboard Tabs**: Determines whether or not other Dashboards published in the workbook should be shown
  ...
  2. **Styled (Web Friendly)** - Show tabs that can be styled in the Themes (Backend > Settings > Curator > Themes >
   select your Theme > *Title and Toolbar* tab). Check out our Design options [here](https://curator.interworks.com/page/kb/site-content-design/theme/titles-and-toolbars/1337).
...
- **Search & Content Discovery**: Add keywords to associate with your Dashboard. When users search for the specified
  keyword, the Dashboard will appear in the results. To add new keywords refer to [this guide](https://curator.interworks.com/page/kb/site-content-design/content-discovery/keywords/1070).
...
- **Loading Screen**: Select the loading screen to display while this Dashboard is loading. If you want to add new
  loading screens to the options, check out [this guide](https://curator.interworks.com/page/kb/site-content-design/loading-screens/loading-screens/1067).

- **Tutorial**: Select a tutorial to show when users navigate to the Dashboard.
  [This guide](https://curator.interworks.com/page/kb/site-content-design/user-notifications/tutorials/1066)
  walks you through the steps of how to create a tutorial.

- **Comments**: Enable [*User Commenting*](https://curator.interworks.com/page/kb/embedding-using-analyticsdata-manager/user-commenting/1081)
  if you want to allow users to add comments to the Dashboard. To use this feature, you need to have Data Manager
  enabled. If you don't have Data Manager enabled yet, refer to [these steps](https://curator.interworks.com/page/kb/embedding-using-analyticsdata-manager/data-manager-basics/1253).
...
- **Filters**: Add any of the selectable Curator filters to the Dashboard. Filters that don't match any field in your
  ...
  Check out [this guide](https://curator.interworks.com/page/kb/embedding-using-analyticsfilters-parameters/filters/1060)
  to add new Filters.
...
- **Parameters**: Add any of the selectable Curator parameters to the Dashboard. Parameters that don't match any field
  in your applied data source will be greyed out.
   Check out [this guide](https://curator.interworks.com/page/kb/embedding-using-analyticsfilters-parameters/parameters/1061)
...
customize Curator's default behavior. Check out
 [this documentation](https://curator.interworks.com/page/kb/embedding-using-analyticsfilters-parameters/specify-filter-sheet/1065)
 for all the details.
...
- **Report Builder**: If Report Builder is enabled, you can specify a sheet for export to presentations in the
  *Use PPTX Tab* field. You can also specify an *Alternate Report Builder Dashboard Link* to use this Dashboard
  ...
  [here](https://curator.interworks.com/page/kb/embedding-using-analyticsreport-builder/overview-and-enabling/1050).
...
- **Inline Mark Commenting**: Details on Inline Mark Commenting and how to set it up can be found in
  [this documentation article](https://curator.interworks.com/page/kb/embedding-using-analyticsdata-manager/mark-commenting/1068).
