---
title: 'Chrome 142 and Edge 143 Tableau Embedding Issues'
description: 'Troubleshoot embedded Tableau views that fail to load in Chrome 142 or Edge 143 due to Local Network Access restrictions'
---
...
<Frame>
  ![Example error message](/assets/images/embedding_using_analytics/tableau_dashboards/unknown-auth-error.png)
</Frame>
