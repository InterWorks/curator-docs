...
![Full app modal element](/assets/images/thoughtspot/full_app_embed_pb.png)
4. Once the element is added, choose the Org where your ThoughtSpot data lives from the left-hand panel:
![Import SAML metadata](/assets/images/thoughtspot/full_app_embed_page_builder_org_dropdown.png)
5. Finally choose the Homepage experience you'd like to use:
    ![Search bar dropdown](/assets/images/thoughtspot/full_app_embed_page_builder_search_bar_dropdown.png)
    - **Classic Homepage** (default) - The traditional ThoughtSpot homepage experience
        ![Classic homepage embed](/assets/images/thoughtspot/full_app_embed_classic.png)
    - **Spotter Homepage** - ThoughtSpot's new natural language search interface
        ![Spotter Homepage embed](/assets/images/thoughtspot/full_app_embed_spotter.png)
