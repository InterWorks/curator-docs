...
description: 'Configure fallback images for reports when live dashboard content cannot be rendered or is unavailable.'
---
...
Before you proceed below, you need to upload your file using the [File](https://curator.interworks.com/page/kb/site-content-designfiles/files/1077)
system in Curator.
