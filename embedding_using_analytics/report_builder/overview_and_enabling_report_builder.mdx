---
title: 'Overview and Enabling Report Builder'
description: 'Introduction to Report Builder functionality and step-by-step instructions for enabling report generation capabilities.'
---
