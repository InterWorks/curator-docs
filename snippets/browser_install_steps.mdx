...
![License key prompt page](/docs_assets/images/snippets/installation_enter_key.png)
...
![Database credentials prompt page](/docs_assets/images/snippets/enter_database_credentials.png)

**Success!**

If the installation is successful, you will be redirected to your new Curator homepage

![Database credentials prompt page](/docs_assets/images/snippets/post_install_homepage.png)
