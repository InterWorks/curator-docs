---
title: 'Homepage'
description: 'Configure and customize the homepage layout, content, and design elements to create an engaging user landing experience.'
---

Curator allows you to create unique web pages using
[Curator's page builder](https://curator.interworks.com/page/kb/documentationpages/pages-overview/1078) to customize
...
[steps to create a page](https://curator.interworks.com/page/kb/documentationpages/pages-overview/1078) first.  Once
