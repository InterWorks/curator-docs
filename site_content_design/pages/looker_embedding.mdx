---
title: 'Looker Embedding'
description: 'Embed Looker reports and dashboards directly into Curator pages for integrated analytics viewing.'
---
...
![GIF illustrating the steps written above](/assets/images/site_content_design/pages/looker.gif)
