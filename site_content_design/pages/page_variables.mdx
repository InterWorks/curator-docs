...
description: 'Use dynamic page variables to display user-specific and session-based information within page content.'
---
...
![Example of page variables using the text element](https://curator.interworks.com/file/page-variables-example)
