...
description: 'Embed YouTube videos directly into Curator pages for educational content and multimedia presentations.'
---
...
![GIF illustrating the steps written above](/assets/images/site_content_design/pages/youtube.gif)
