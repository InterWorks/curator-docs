---
title: 'Search'
description: 'Enable and configure search functionality to help users discover and locate content across the Curator portal.'
---
...
page by using [Page Builder](/site_content_design/pages/pages_overview)_
...
![search result example!](/assets/images/site_content_design/content_discovery/search_results.png)
