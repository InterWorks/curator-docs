...
These thumbnails can either be set manually while creating or editing a Dashboard, see the [Embedded Tableau Server Views](https://curator.interworks.com/page/kb/embedding-using-analyticstableau-dashboards/custom-views/1057)
section for more information), or the system will attempt to automatically grab the thumbnail from the Tableau Server
if the Dashboard is created without one.
