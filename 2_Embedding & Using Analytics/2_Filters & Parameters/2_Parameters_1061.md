...
8. Select the filter category if desired. See the [Filter Categories Section](https://curator.interworks.com/page/kb/embedding-using-analytics/filters-parameters/filter-categories/1063)
for more
information.
