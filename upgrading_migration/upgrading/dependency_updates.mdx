...
description: 'Instructions for updating PHP, Apache, or MariaDB dependencies on your Curator webserver.'
---
...
2. Download the following files to the same directory as the utility.
   ...
   - **vc_redist.exe** - VC Redistributables: [https://api.curator.interworks.com/file/vc_redist](https://api.curator.interworks.com/file/vc_redist)
   - **php.zip** - PHP package: [https://api.curator.interworks.com/file/php_apache](https://api.curator.interworks.com/file/php_apache)
