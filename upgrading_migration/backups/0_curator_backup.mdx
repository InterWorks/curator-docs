...
2. Navigate to the **Settings** > **Curator** > **Import/Export** in the left-hand menu.
3. Click on the "Full Backup" tab at the top.
4. Click the "Take New Backup" button to start a backup.  If you would like to check the status of the backup
...
3. Click on the "Full Backup" tab at the top.
4. Find the backup from the list view (NOTE: They are all appended with a timestamp from when they were
